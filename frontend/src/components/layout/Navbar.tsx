...
import { Bell, MessageSquare, Users, User, MessageCircle, X, Shield, LogOut } from 'lucide-react';
    ...
    <>
      ...
      {discordOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setDiscordOpen(false)}>
          ...
          >
            <button onClick={() => setDiscordOpen(false)} className="absolute top-4 right-4 text-[#505568] hover:text-[#ECF0F8] transition-colors">
              <X size={16} />
            </button>
      ...
      {complainOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setComplainOpen(false)}>
          ...
          <div
            ...
            onClick={e => e.stopPropagation()}
          >
            <button onClick={() => setComplainOpen(false)} className="absolute top-4 right-4 text-[#505568] hover:text-[#ECF0F8] transition-colors">
              <X size={16} />
            </button>
