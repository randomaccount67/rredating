        ...
        {[
          {
            ...
            content: 'We collect: your email address (via Google OAuth authentication), Riot ID and tag (self-reported), rank and gameplay info (self-reported), profile picture (uploaded by you), messages you send on the platform, region and role preferences.'
          },
          {
          ...
          },
          {
            ...
            content: 'Your data is stored in Supabase (PostgreSQL database) hosted in the United States. Profile pictures are stored in Supabase Storage. Authentication is handled by Supabase Auth.'
          },
          {
          ...
          },
          {
            ...
            content: 'We use Supabase Auth for authentication (via Google OAuth), Supabase for database and storage, and Netlify/Vultr for hosting. These services have their own privacy policies.'
          },
          {
          ...
          {
            title: '7. COOKIES',
            content: 'We use cookies for authentication (managed by Supabase Auth). We do not use tracking cookies or advertising cookies.'
          },
          {
            title: '8. MINORS',
