...
export const PROFILE_PUBLIC_COLUMNS =
  'id, riot_id, riot_tag, avatar_url, current_rank, peak_rank, role, agents, music_tags, about, gender, region, favorite_artist, is_online, created_at, age, is_verified';

/** Browse page columns (same shape but used in match filtering context). */
export const BROWSE_COLUMNS =
  'id, riot_id, riot_tag, region, current_rank, peak_rank, role, agents, about, avatar_url, music_tags, favorite_artist, gender, is_online, created_at, age, mic_on, is_verified';
