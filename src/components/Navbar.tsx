    ...
    <>
      ...
      {discordOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setDiscordOpen(false)}>
          ...
          <div
            className="relative w-full max-w-sm bg-[#1A1D24] border border-[#5865F2]/40 p-6"
            style={{ clipPath: 'polygon(0 0, calc(100% - 16px) 0, 100% 16px, 100% 100%, 0 100%)' }}
            onClick={e => e.stopPropagation()}
          >
            <button onClick={() => setDiscordOpen(false)} className="absolute top-4 right-4 text-[#525566] hover:text-[#E8EAF0] transition-colors">
              <X size={16} />
            </button>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[#525566] font-mono text-[10px] tracking-widest uppercase">// COMMUNITY</span>
            </div>
